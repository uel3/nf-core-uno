process TRIMMOMATIC {
    ...
    def qual_trim = 'ILLUMINACLIP:$HOME/UnO_nf/nf-core-uno/assets/TruSeq3-PE.fa:20:30:10:8:True LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36' //"${params.adapter_seqeunce}"
    """
    trimmomatic \\
        $trimmed \\
        -threads $task.cpus \\
